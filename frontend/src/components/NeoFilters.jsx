...
const NeoFilters = ({ onFilterChange, startDate, endDate }) => {
    ...
    <form onSubmit={handleFilterSubmit} className="flex justify-center items-center mb-6">
      <div className="mx-2">
        <label className='block text-sm font-medium mb-1'>
          Filter Date on Nearest Approach:
        </label>
        <input
          type="date"
          ...
          min={startDate}  // Set minimum date as the startDate
          max={endDate}    // Set maximum date as the endDate
        />
      </div>
      <div className='mx-2'>
